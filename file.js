...
const PUBLICATIONS = [
  { id: 'p1', title: 'Vulnerabilities of AI in Cybersecurity', year: 2025, authors: 'Shahabudidn, Shahid', venue: 'International Journal of scientific and Engineering Research', area:'AI', cover: 'images/Research 1.jpg', link:'https://www.ijser.in/abstract.php?paperid=SE25604130052'},
  { id: 'p2', title: 'AI-Driven in Prevenative Healthcare', year: 2025, authors: 'Shahabuddin Shahid, Walid Atif', venue: 'Frontiers in Digital Health', area:'Health', cover: 'images/Research 2.jpg', link:'#' },
  { id: 'p3', title: 'Generativ AI in Critical thinking and Problem Solving in Higher Education', year: 2025, authors: 'Shahabuddin Shahid, Mahjabin Shahid', venue: 'International Journal of Educational Technology in Higher Education', area:'Education', cover: 'images/Research 4.jpg', link:'https://www.springeropen.com/collections/AIHE' },
  { id: 'p4', title: 'Multi-Cloud & Hybrid Security', year: 2026, authors: 'Shahabuddin Shahid', venue: 'IEEE Acess', area:'Cybersecurity', cover: 'images/Research 5.png', link:'#'},
  ...
  { id: 'p6', title: 'Integrating AI and Clinical Decision Support for Medical Diagnoses During Surgery', year: 2023, authors: 'Walid Atif', venue: 'The New England Journal of Medicine', area:'Health', cover: 'images/Research 6.png', link:'#' },
];
...
const RESEARCHERS = [
  { 
    ...
    cv:'#',
    pubs:['p5','p3'],
    affiliations:['Axonyra Research (2025—Present)','UiTM Malaysia, Master of Health Science (2016—2018)', 'Bachelor of Medical (2012—2018)'],
    experience:[
    ...
    email:'mahjabin.shahid@exonyra.com', phone:'+1 (202) 555-0186'
  },
  { 
    id:'r2',
    ...
    cv:'CV/Shahid.pdf',
    pubs:['p1','p2','p3','p4'],
    affiliations:['Axonyra Research (2025—Present)','Cisco Networking Academy (Partner Lab)'],
    experience:[
      { role:'Junior Reseaercher', org:'Axonyra', years:'2025—present' },
      { role:'Computer Science Student', org:'Technische üniversität Berlin', years:'2025—Present' }
    ],
    email:'shahab.shahid@exonyra.com', phone:'+49 157 81178053'
  },
  { 
    id:'r3',
    name:'Ahmad Walid Atif', role:'Clinical Researcher & CTO of Axonyra', focus:['Medical Innovation','Education','Artificial Intelligence'],
    ...
    cv:'#',
    pubs:['p2','p6'],
    affiliations:['Axonyra Research (2025—Present)','Kabul Medical University (Alumni)'],
    experience:[
      { role:'Clinical Researcher', org:'Axonyra', years:'2025—present' },
      { role:'Medical Doctor', org:'Kabul Medical University', years:'2017—2024' }
    ],
    email:'awalid.atif@exonyra.com', phone:'+93 74880 2971'
  },
];
